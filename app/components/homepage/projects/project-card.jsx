          ...
          <code className="font-mono text-xs md:text-sm lg:text-base">
            ...
            {project.demo || project.code ? (
                <div className="ml-4 lg:ml-8 mr-2">
                  ...
                  {project.demo && (
                      <Link href={project.demo} target="_blank" className="text-pink-500 underline ml-1">
                        Live
                      </Link>
                  )}
                  {project.code && (
                      <>
                        ...
                        <Link href={project.code} target="_blank" className="text-pink-500 underline ml-1">
                          GitHub
                        </Link>
                      </>
                  )}
